...
struct ProdDequantKernel {
    ...
    void Compute(OrtKernelContext* context) {
        ...
        switch (bits) {
            case 2: e = s2->dequantize({m_p,batch*mb},{q_p,batch*qb},{r_p,batch},{n_p,batch},batch,{x_p,batch*dim}); break;
            case 3: e = s3->dequantize({m_p,batch*mb},{q_p,batch*qb},{r_p,batch},{n_p,batch},batch,{x_p,batch*dim}); break;
            case 4: e = s4->dequantize({m_p,batch*mb},{q_p,batch*qb},{r_p,batch},{n_p,batch},batch,{x_p,batch*dim}); break;
        }
        if (e != Error::Ok)
