...
Result<RingBuffer> RingBuffer::make(std::size_t capacity, std::size_t num_kv_heads,
...
Error RingBuffer::write(std::span<const float> keys, std::span<const float> values,
